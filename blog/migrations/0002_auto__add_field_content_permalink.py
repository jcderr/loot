...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Content.permalink'
        db.add_column(u'blog_content', 'permalink',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Content.permalink'
        db.delete_column(u'blog_content', 'permalink')
    ...
    models = {
        ...
        u'blog.content': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'permalink': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
